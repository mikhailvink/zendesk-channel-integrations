...
VALUES (
'" . $date . "',  '" . $remote_addr . "',  '" . $request_uri . "', '" . $message . "',  'YouTube',  '');");
...
VALUES (
'" . $date . "',  '" . $remote_addr . "',  '" . $request_uri . "', '" . addslashes($message) . "',  'YouTube',  '" . json_decode($message, true)['events'][0]['subdomain'] . "', '" . json_decode($message, true)['events'][0]['type_id'] . "', '".$error."');");
